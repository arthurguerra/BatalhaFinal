...
public class BatalhaFinal {
	...
	public static void main(String[] args) {
		...
		BatalhaFinalController batalhaFinalController = new BatalhaFinalController();
		...
		do {
			try {
				jogador = batalhaFinalController.criaJogador();
				repetir = false;
			} catch (Exception e) {
		...
		do {
			try {
				JogadorController.escolheMotivacao(jogador);
				repetir = false;
			} catch (Exception e) {
				System.err.println(e.getMessage());
			}
		...
		do {
			try {
				// TODO: if (desiste)
				if (batalhaFinalController.perguntaSeQuerDesistir()) {
		...
		String comoPassarPelaPorta = null;

		do {
			try {
				comoPassarPelaPorta = batalhaFinalController.passarPelaPorta();
				repetir = false;
			}catch (Exception e) {
				System.err.println(e.getMessage());
			}
		...
		// TODO: if SALTANDO
		if (comoPassarPelaPorta.equals("SALTANDO")){
		...
		} else if (comoPassarPelaPorta.equals("CORRENDO")) {
